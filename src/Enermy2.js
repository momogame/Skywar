var	Enermy3 = cc.Sprite.extend({
	ctor: function(gameLayer,id,type) {
		this.gameLayer = gameLayer;
		this._super();
		this.monID=id;
		this.type=type;
        this.initWithFile( 'image/enermy/mon3.png' );
        //this. setScale	(0.5);
        this.vy = 1.5;
        var animation = new cc.Animation.create();
        animation.addSpriteFrameWithFile( 'image/enermy/mon3.png' );
        animation.addSpriteFrameWithFile( 'image/enermy/mon4.png' );
        animation.addSpriteFrameWithFile( 'image/enermy/mon5.png' );
...
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
	...
	var	Enermy4 = cc.Sprite.extend({
		ctor: function(gameLayer,id,type) {
			this.gameLayer = gameLayer;
			this._super();
			this.monID=id;
			this.type=type;
        	this.initWithFile( 'image/enermy/mon6.png' );
        	this. setScale	(1.4);
        	this.vy = 1.5;
        	this.i = 0;

        	var animation = new cc.Animation.create();
        	animation.addSpriteFrameWithFile( 'image/enermy/mon6.png' );
        	animation.addSpriteFrameWithFile( 'image/enermy/mon7.png' );
        	animation.addSpriteFrameWithFile( 'image/enermy/mon8.png' );
        	animation.setDelayPerUnit( 0.2 );
        	var movingAction = cc.RepeatForever.create( cc.Animate.create( animation ) );
        	this.runAction( movingAction );
